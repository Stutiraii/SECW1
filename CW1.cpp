...
public:
    ...
    void initializeBooks(const std::vector<BookData>& bookData) {
        ...
        for (const auto& bookInfo : bookData) {
            ...
            // Modify the Book class constructor accordingly
            ...
            // Assuming that due date and borrower information is available
            Date dueDate = today;  // Start with today's date
            dueDate = addDays(dueDate, 14);  // Add 14 days to get the due date

            std::string borrower = "N/A";  // Adjust this based on your CSV data
